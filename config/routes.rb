Intranet::Application.routes.draw do
  ...
  get 'cancel_leave_application' => 'leave_applications#cancel_leave', as: :approve_leave 
  get 'approve_leave_application' => 'leave_applications#approve_leave', as: :cancel_leave
  resources :projects
